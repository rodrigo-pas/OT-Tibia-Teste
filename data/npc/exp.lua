...
local function creatureSayCallback(cid, type, msg)
    ...
    if msgcontains(msg, 'experience') then
        local cost = Player(cid):getStorageValue(55656) * 100
        npcHandler:say('Are you looking to increase your experience? It will cost you ' .. cost .. ' gold. Your current level is ' .. player:getStorageValue(55656) .. '.', cid)
    ...
    if npcHandler.topic[cid] == 1001 and msgcontains(msg, 'yes') then
        ...
        if player:getMoney() >= cost then
            ...
            Player(cid):setStorageValue(55656, Player(cid):getStorageValue(55656) + 1)
            npcHandler:say('Fine, now your idle experience level is ' .. Player(cid):getStorageValue(55656) .. '.', cid)
        else
